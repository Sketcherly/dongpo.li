---
title: "JVM默认参数"
date: 2020-01-13T20:42:54+08:00
draft: false
summary: 'JVM的大部分的参数都指定了默认值,本文来了解这些参数列表和一些参数默认值.'
---


# 说明
JVM的大部分的参数都指定了默认值,本文来了解这些参数列表和一些参数默认值.


# 查看启动参数
在机器上可以使用如下命令查看jvm启动时的一些参数
``` shell
...
- MaxNewSize  新生代最大内存,默认是整个堆内存的40%(G1的话是40%个Region,四舍五入)
- 老年代默认最大占堆内存的40%
- Eden和Servivor比例默认是8:1:1
